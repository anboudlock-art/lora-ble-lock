...
//void Timer_EVT_TIMBASE(void)
//{
//	TIMER_EVT|=EVT_TIMBASE;
//}
...
#ifdef	EVT_1S_OTA
	Timer_Evt_Creat(EVT_1S_OTA,1000,Timer_EVT_1S_OTA,EVT_DISABLE_MODE);	 	 //生成触发事件
#endif
	
//	Timer_Evt_Creat(EVT_TIMBASE,10,Timer_EVT_TIMBASE,EVT_DISABLE_MODE);	 	 //生成触发事件
}
